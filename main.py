...
data_root = {
    # 'ImageNet': '/data/qinwei206/ImageNet_LT',
    'ImageNet': '/root/autodl-tmp/imagenet',
    #  'ImageNet': '/data/linshiqi047/imagenet',
    'Places': '/data/zhangfan/Places365',
    'iNaturalist18': '/home/zhangfan',
    'CIFAR10': '/data/public/cifar',
    'CIFAR100': '/data/public/cifar/',
}
